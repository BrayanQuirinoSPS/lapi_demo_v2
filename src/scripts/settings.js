...
const colors_lapi_2={    //custom colors property  
    "branding": lapi_2,
    "headerBackground": lapi_2,
    "visualizer": "#fff",
    "headerButtonFill": "#fff",
    "text": "#000",
    //"textLight": "#737373",
    //conversationBackground: "#fff",
    //"footerBackground": lapi_2,
    //"footerButtonFill": lapi_2,
...
const initSdk = (name) => {
    ...
    let logo='https://github.com/BrayanQuirinoSPS/notas/raw/master/Oracle_Digital_Assitant/Lapi/chatbot_web/src/images/logo2.png'
    setTimeout(() => {
        /**
